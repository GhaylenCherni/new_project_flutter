...
//import 'package:udemy_flutter/modules/shop_app/favorites/settings_screen.dart';
//import 'package:udemy_flutter/modules/shop_app/favoritess/favorites_screen.dart';
...
//import 'package:udemy_flutter/modules/shop_app/settings/favorites_screen.dart';
...
class ShopCubit extends Cubit<ShopStates>
{
...

  {
    ...
    DioHelper.postData(
      ...
      print(value!.data);
      if (changeFavoritesModel?.status != null && !changeFavoritesModel!.status!) {
        favorites[productId] = !favorites[productId]!;
      }else{
        getFavorites();
      }
